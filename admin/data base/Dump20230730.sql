...
--
-- Table structure for table `ContenuWeb`
--

DROP TABLE IF EXISTS `ContenuWeb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ContenuWeb` (
  ...
  `id_ContenuWeb_type` int DEFAULT NULL,
  `id_article` int DEFAULT NULL,
  `id_categorie` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ContenuWeb_ContenuWeb_type_idx` (`id_ContenuWeb_type`),
  KEY `article_ContenuWeb_idx` (`id_article`),
  KEY `categorie_ContenuWeb_idx` (`id_categorie`),
  CONSTRAINT `ContenuWeb_ContenuWeb_type` FOREIGN KEY (`id_ContenuWeb_type`) REFERENCES `ContenuWeb_type` (`id`),
  CONSTRAINT `article_ContenuWeb` FOREIGN KEY (`id_article`) REFERENCES `article` (`id`),
  CONSTRAINT `categorie_ContenuWeb` FOREIGN KEY (`id_categorie`) REFERENCES `categorie` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ContenuWeb`
--

LOCK TABLES `ContenuWeb` WRITE;
/*!40000 ALTER TABLE `ContenuWeb` DISABLE KEYS */;
INSERT INTO `ContenuWeb` VALUES (39,'hgfvd',NULL,'<p><strong>yhtgrf </strong></p><p><em>sff tyku,</em></p><p><em>sff tyku,</em></p>',NULL,'zkzA09gFkY.jpg',NULL,NULL,3,0,4,NULL,NULL),(40,'hgb tgr',NULL,'<p><strong>emou momeerjfô moehggooen perhp hzjl fiuruhg uerhu</strong></p>',NULL,NULL,NULL,NULL,4,0,2,NULL,NULL),(41,'hi hozon topo your ara welcom',NULL,'<p>the best way to have maps</p>',NULL,NULL,NULL,NULL,1,0,1,NULL,NULL),(42,'zzzzz ggggggg',NULL,'<h2>oiut</h2>',NULL,'GTAf2p3Dfu356375308_3423462734585928_6192325212685890937_n.jpg',NULL,NULL,4,0,4,NULL,NULL),(43,'Top service',NULL,'<p>Mais services disponible à nos client. Vous pouvez me contacter pour tout autre information complémentaire </p>',NULL,NULL,NULL,NULL,5,0,3,NULL,NULL),(44,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,0,5,NULL,NULL),(45,'gjtsvvyuk yryrh',NULL,'<p>yukdfer rtryjj rtrtrt gjtsvvyuk yryrh yukdfer rtryjj rtrtrt gjtsvvyuk yryrh yukdfer rtryjj rtrtrt gjtsvvyuk yryrhyukdfer rtryjj rtrtrt gjtsvvyuk yryrh</p>',NULL,NULL,NULL,NULL,5,0,6,NULL,NULL),(46,'rjy tuklyu ty',NULL,'<p>rjy ty rjy tuklyu ty rjy tuklyu ty rjy tuklyu ty rjy tuklyu ty </p>',NULL,NULL,NULL,NULL,6,0,7,NULL,NULL),(47,'les blog',NULL,'<p>Sujet intéressant à lire et commenté</p>',NULL,NULL,NULL,NULL,7,0,8,NULL,NULL),(54,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,10,NULL,NULL),(55,'uygd',NULL,'<p>ytgf</p>',NULL,NULL,NULL,NULL,2,0,11,NULL,NULL),(56,'sv ere ebeb',NULL,'<p>ebeb sv sv ere ebebere ebeb sv ere ebeb</p>',NULL,NULL,NULL,NULL,3,0,12,NULL,NULL);
/*!40000 ALTER TABLE `ContenuWeb` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ContenuWeb_type`
--

DROP TABLE IF EXISTS `ContenuWeb_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ContenuWeb_type` (
  `id` int NOT NULL,
  `type` varchar(450) DEFAULT NULL,
  `sub_type` varchar(45) DEFAULT NULL,
  `id_resolution` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `resolution_ContenuWeb_type_idx` (`id_resolution`),
  CONSTRAINT `resolution_ContenuWeb_type` FOREIGN KEY (`id_resolution`) REFERENCES `resolution_by_content` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ContenuWeb_type`
--

LOCK TABLES `ContenuWeb_type` WRITE;
/*!40000 ALTER TABLE `ContenuWeb_type` DISABLE KEYS */;
INSERT INTO `ContenuWeb_type` VALUES (1,'Bannière ( image 1920_1080 )','LIST',1),(2,'Liste 2 / N élements ( image 800_600 )','LIST',2),(3,'Liste 3 / N élements ( image 48_48 )','LIST',3),(4,'Image à gauche 1024_768 et groupe de textes ','LIST',4),(5,'Liste tabs Image ( image 800_600 )','LIST',2),(6,'Groupe 3 / N élements  ( image 1024_768 )','LIST_GROUPE',4),(7,'Liste déroulante  ( image 400_400 )','LIST',6),(8,'Liste 3 / N élements ( image 1024_768 )','LIST',NULL),(9,'Image à gauche 1024_768 et une descriptioon','LIST',4),(10,'Statistique','LIST',NULL),(11,'Equipe','LIST',NULL),(12,'Testimonials','LIST',NULL);
/*!40000 ALTER TABLE `ContenuWeb_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ContenuWeb_type_resolution`
--

DROP TABLE IF EXISTS `ContenuWeb_type_resolution`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ContenuWeb_type_resolution` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_ContenuWeb_type` int DEFAULT NULL,
  `id_resolution` int DEFAULT NULL,
  `ordre` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ContenuWeb_type_ContenuWeb_type_resolution_idx` (`id_ContenuWeb_type`),
  KEY `resolution_ContenuWeb_type_resolution_idx` (`id_resolution`),
  CONSTRAINT `ContenuWeb_type_ContenuWeb_type_resolution` FOREIGN KEY (`id_ContenuWeb_type`) REFERENCES `ContenuWeb_type` (`id`),
  CONSTRAINT `resolution_ContenuWeb_type_resolution` FOREIGN KEY (`id_resolution`) REFERENCES `resolution_by_content` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ContenuWeb_type_resolution`
--

LOCK TABLES `ContenuWeb_type_resolution` WRITE;
/*!40000 ALTER TABLE `ContenuWeb_type_resolution` DISABLE KEYS */;
INSERT INTO `ContenuWeb_type_resolution` VALUES (1,1,1,1),(2,2,2,1),(3,3,3,1),(4,4,5,1),(5,5,2,1),(6,6,4,1),(7,7,6,1),(8,8,4,1),(10,10,7,1),(11,11,8,1),(12,12,6,1);
/*!40000 ALTER TABLE `ContenuWeb_type_resolution` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `categorie` VALUES (1,'ContenuWeb','<p><br></p>',NULL,0,1,'uyhg',', yhtgfvdcx \npoiujyhgf'),(2,'name 2','<p><br></p>',NULL,1,2,'name 2','name 2'),(3,'name 1.1',NULL,1,1,3,NULL,NULL),(4,'name 1.2',NULL,1,1,1,'name 1.2','name 1.2'),(5,'name 1.1.1',NULL,3,1,NULL,NULL,NULL),(6,'name 1.1.1.1',NULL,5,1,NULL,NULL,NULL),(33,'name 3',NULL,NULL,1,2,'name 3','name 3'),(34,'name 4',NULL,NULL,1,3,'name 4','name 4'),(35,'Qui   somme nous','<p>Page pour decrir la societe a</p>',NULL,0,2,'Qui   somme nous','Page pour decrir la societe '),(36,'Blog','<p><br></p>',NULL,0,2,'Blog',NULL),(37,'bloc 1 ldjkfvn','<p><br></p>',36,0,1,'b1','2023-07-15 09:34:44'),(38,'b2 bloc 2 ldjkfvn','<p><br></p>',36,0,2,'b2','2023-07-15 09:34:54');
/*!40000 ALTER TABLE `categorie` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `categorie_ContenuWeb`
--

DROP TABLE IF EXISTS `categorie_ContenuWeb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `categorie_ContenuWeb` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_categorie` int DEFAULT NULL,
  `id_ContenuWeb` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `categorie_ContenuWeb__idx` (`id_categorie`),
  KEY `categorie_ContenuWeb_idx` (`id_ContenuWeb`),
  CONSTRAINT `categorie_ContenuWeb_1` FOREIGN KEY (`id_ContenuWeb`) REFERENCES `ContenuWeb` (`id`),
  CONSTRAINT `categorie_ContenuWeb_2` FOREIGN KEY (`id_categorie`) REFERENCES `categorie` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `categorie_ContenuWeb`
--

LOCK TABLES `categorie_ContenuWeb` WRITE;
/*!40000 ALTER TABLE `categorie_ContenuWeb` DISABLE KEYS */;
INSERT INTO `categorie_ContenuWeb` VALUES (18,1,46),(19,1,55),(20,1,41),(21,1,40),(22,1,39),(23,1,43),(24,1,47);
/*!40000 ALTER TABLE `categorie_ContenuWeb` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `ligne_ContenuWeb`
--

DROP TABLE IF EXISTS `ligne_ContenuWeb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ligne_ContenuWeb` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(105) DEFAULT NULL,
  `name2` varchar(105) DEFAULT NULL,
  `text` text,
...
INSERT INTO `parametre` VALUES (1,'Article colomne','{\n     \"fields\" : \n             [\n               {\n                 \"name\" : \"name\",\n                 \"type\" : \"text\",\n                 \"label\" : \"Nom\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"filter\" : \n                 {\n                   \"show\" : true,\n                   \"type\" : \"text\",\n                   \"value\" : \"\",\n                   \"operator\" : \"%%\"\n                 },\n                 \"show\" : true,\n                 \"required\" : true,\n                 \"active\" : true,\n                 \"order\" : 1\n               },\n                {\n                 \"name\" : \"name2\",\n                 \"type\" : \"text\",\n                 \"label\" : \"Nom 2\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",                \n                 \"show\" : false,\n                 \"required\" : false,\n                 \"active\" : true,\n                 \"order\" : 1\n               },\n               {\n                 \"name\" : \"description\",\n                 \"type\" : \"text\",\n                 \"label\" : \"Texte 1\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"filter\" : \n                 {\n                   \"show\" : true,\n                   \"type\" : \"text\",\n                   \"value\" : \"\",\n                   \"operator\" : \"%%\"\n                 },\n                 \"show\" : true,\n                 \"required\" : true,\n                 \"active\" : true,\n                 \"order\" : 2\n                 \n               },     \n               {\n                 \"name\" : \"date1\",\n                 \"type\" : \"date\",\n                 \"label\" : \"Date création\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",                 \n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : false,\n                 \"order\" : 3                 \n               },        \n               {\n                 \"name\" : \"id_model_affichage\",\n                 \"type\" : \"text\",\n                 \"label\" : \"Modél\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",                 \n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true,\n                 \"order\" : 3                 \n               },   \n               {\n                 \"name\" : \"debut_promo\",\n                 \"type\" : \"date\",\n                 \"label\" : \"Début promo\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"filter\" : \n                 {\n                   \"show\" : true,\n                   \"type\" : \"date\",                   \n                \"returnProperty\":\"debut_promoFilter\",\n                   \"value\" : \n                              {\n                                   \"start\" :  \"\", \n                                   \"end\" : \"\"\n                               }\n                 },\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true,\n                 \"order\" : 3\n                 \n               },             \n               {\n                 \"name\" : \"is_deleted\",\n                 \"type\" :  \"icon\",\n                 \"label\" : \"Supprimer\",\n                 \"filter\" : \n                         {\n                           \"show\" : true,\n                           \"type\" : \"checkbox\",\n                           \"value\" :\"\",\n                           \"operator\" : \"=\"\n                         },\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"show\" : true,\n                 \"active\" : true,\n                 \"required\" : true,\n                 \"order\" : 6\n               },\n               {\n                 \"name\" : \"full_description\",\n                 \"label\" : \"Texte 2\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : false\n               },\n               {\n                 \"name\" : \"price\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"new_price\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"fin_promo\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"badge\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"disponible\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"quantite\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"valider\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"id_fournisseur\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"id_marque\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"tva\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"title_seo\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"description_seo\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true\n               },\n               {\n                 \"name\" :\"action\",\n                 \"type\" : \"action\",\n                 \"label\" : \"Action\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"buttons\" :  \n                 [\n                   {\"name\" :\"delete\",\"icon\" :\"delete\",\"label\" : \"Supprimer\",\"color\" :\"#f44336\"},\n                   {\"name\" :\"edit\",\"icon\" :\"edit\",\"label\" : \"Editer\",\"color\" :\"#3f51b5\"}\n                 ],\n                  \"active\" : true, \n                  \"show\" : true,\n                 \"required\" : true,\n                 \"order\" : 8\n               }\n             ],\n     \"showFilter\" : true,\n     \"breakpoint\" : 830\n   }',NULL,NULL,NULL,NULL,0),(2,'Parametre colomne','{\n    \"fields\" : \n            [\n              {\n                \"name\" : \"name\",\n                \"type\" : \"text\",\n                \"label\" : \"Nom\",\n                \"minWidth\" : \"100px\",\n                \"width\" : \"30%\",\n                \"filter\" : \n                {\n                  \"show\" : true,\n                  \"type\" : \"text\",\n                  \"value\" : \"\",\n                   \"operator\" : \"%%\"\n                },\n                \"show\" : true,\n                \"required\" : true,\n                \"active\" : true,\n                \"order\" : 1\n                \n              },\n              {\n                \"name\" : \"value\",\n                \"type\" : \"text\",\n                \"label\" : \"Valeur\",\n                \"minWidth\" : \"100px\",\n                \"width\" : \"30%\",\n                \"filter\" : \n                {\n                  \"show\" : true,\n                  \"type\" : \"text\",\n                  \"value\" : \"\",\n                   \"operator\" : \"%%\"\n                },\n                \"show\" : true,\n                \"required\" : true,\n                \"active\" : true,\n                \"order\" : 2\n                \n              },   \n              {\n                \"name\" : \"type\",\n                \"type\" : \"text\",\n                \"label\" : \"Type\",\n                \"minWidth\" : \"100px\",\n                \"width\" : \"30%\",\n                \"filter\" : \n                {\n                  \"show\" : true,\n                  \"type\" : \"select\",\n                  \"showEmptyValue\" : true,\n                  \"returnProperty\" : \"type\",\n                  \"data\" : [],\n                  \"id\" : \"type\",\n                  \"name\" : \"type\",\n                   \"operator\" : \"=\",\n                   \"value\" : \"\"\n                },\n                \"show\" : true,\n                \"active\" : true,\n                \"required\" : false,\n                \"order\" : 3\n                \n              }, \n              {\n                \"name\" : \"sub_type\",\n                \"show\" : false,\n                \"active\" : true,\n                \"required\" : false\n              },\n              {\n                \"name\" : \"type_content\",\n                \"show\" : false,\n                \"active\" : true,\n                \"required\" : true\n              },\n              {\n                \"name\" : \"ordre\",\n                \"show\" : false,\n                \"active\" : true,\n                \"required\" : false\n              },\n              {\n                \"name\" : \"visible\",\n                \"show\" : false,\n                \"active\" : false,\n                \"required\" : true\n              },\n              {\n                \"name\" :\"action\",\n                \"type\" : \"action\",\n                \"label\" : \"Action\",\n                \"minWidth\" : \"100px\",\n                \"width\" : \"30%\",\n                \"buttons\" :  \n                [\n                  {\"name\" :\"delete\",\"icon\" :\"delete\",\"label\" : \"Supprimer\",\"color\" :\"#f44336\"},\n                  {\"name\" :\"edit\",\"icon\" :\"edit\",\"label\" : \"Editer\",\"color\" :\"#3f51b5\"}\n                ],\n             \"active\" : true,\n              \"show\" : true,\n              \"required\" : true,\n              \"order\" : 8\n              }\n            ],\n    \"showFilter\" : true,\n    \"breakpoint\" : 830\n  }',NULL,NULL,NULL,NULL,0),(3,'ContenuWeb colomne','{\n   \"fields\" : \n           [\n             {\n               \"name\" : \"name\",\n               \"type\" : \"text\",\n               \"label\" : \"Nom\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"text\",\n                 \"value\" : \"\",\n                  \"operator\" : \"%\"\n               },\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWeb\" : [1,2,3,4,6,7,8,11,12]\n             },\n               {\n               \"name\" : \"choix_selection\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,                        \n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : [4]\n             },\n             {\n               \"name\" : \"text\",\n               \"type\" : \"text\",\n               \"label\" : \"Text\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"text\",\n                 \"value\" : \"\",\n                   \"operator\" : \"%%\"\n               },\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 2,\n               \"listeIdTypeContenuWeb\" : [1,2,3,4,6,7,8,11,12]               \n             },   \n             {\n               \"name\" : \"image\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n               \"listeIdTypeContenuWeb\" : [4]               \n             }, \n             {\n               \"name\" : \"type_content\",\n               \"show\" : false,\n               \"active\" : false,\n               \"required\" : true,                        \n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : []     \n             },\n            {\n               \"name\" : \"ordre\",\n               \"type\" : \"text\",\n               \"label\" : \"Ordre\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"number\",\n                 \"value\" : \"\",\n                   \"operator\" : \"=\"\n               },\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWeb\" : [1,2,3,4,5,6,7,8,10,11,12]\n             },\n             {\n                 \"name\" : \"is_deleted\",\n                 \"type\" :  \"icon\",\n                 \"label\" : \"Supprimer\",\n                 \"filter\" : \n                         {\n                           \"show\" : true,\n                           \"type\" : \"checkbox\",\n                           \"value\" :\"\",\n                          \"operator\" : \"=\"\n                         },\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"show\" : true,\n                 \"active\" : true,\n                 \"required\" : true,\n                 \"order\" : 6\n               },\n             {\n               \"name\" : \"ContenuWebType.type\",\n               \"show\" : true,\n               \"active\" : false,\n                \"type\" : \"text\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"label\" : \"Type ContenuWeb\",\n               \"required\" : true,\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"select\",\n                 \"showEmptyValue\" : true,\n                 \"returnProperty\" : \"id_ContenuWeb_type\",\n                 \"data\" : [],\n                  \"operator\" : \"=\",\n                  \"value\" : \"\"\n               },\n               \"order\" : 3\n             },\n             {\n               \"name\" : \"id_article\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" :[4]\n             },\n             {\n               \"name\" : \"id_ContenuWeb_type\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : [1,2,3,4,5,6,7,8]\n             },\n             {\n               \"name\" : \"id_categorie\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : [4]\n             },\n             {\n               \"name\" :\"action\",\n               \"type\" : \"action\",\n               \"label\" : \"Action\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"buttons\" :  \n               [\n                 {\"name\" :\"delete\",\"icon\" :\"delete\", \"label\" : \"Supprimer\",\"color\" :\"#f44336\"},\n                 {\"name\" :\"edit\",\"icon\" :\"edit\",\"label\" : \"Editer\",\"color\" :\"#3f51b5\"}\n               ],\n            \"active\" : true,\n             \"show\" : true,\n             \"required\" : true,\n             \"order\" : 8\n             }\n           ],\n   \"showFilter\" : true,\n   \"breakpoint\" : 830\n }',NULL,NULL,NULL,NULL,0),(4,'Ligne ContenuWeb colonne','{\n   \"fields\" : \n           [\n             {\n               \"name\" : \"name\",\n               \"type\" : \"text\",\n               \"label\" : \"Nom\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWebForParent\":[6],\n              \"listeIdTypeContenuWeb\" : [2,4,5,6,7,10,11,12]               \n             },\n             {\n               \"name\" : \"name2\",\n               \"type\" : \"text\",\n               \"label\" : \"Nom 2\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : false,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWebForParent\":[],\n              \"listeIdTypeContenuWeb\" : [5,7,11,12]               \n             },\n             {\n               \"name\" : \"number1\",\n               \"type\" : \"text\",\n               \"label\" : \"Vote sur 5\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : false,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n                \"max\" : 5,\n               \"listeIdTypeContenuWebForParent\":[],\n              \"listeIdTypeContenuWeb\" : [7,12]               \n             },\n             {\n               \"name\" : \"linkedin\",\n               \"type\" : \"text\",\n               \"label\" : \"Linkedin\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : false,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWebForParent\":[],\n              \"listeIdTypeContenuWeb\" : [11]               \n             },\n             {\n               \"name\" : \"facebook\",\n               \"type\" : \"text\",\n               \"label\" : \"Facebook\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : false,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWebForParent\":[],\n              \"listeIdTypeContenuWeb\" : [11]               \n             },\n              {\n               \"name\" : \"article.name\",\n               \"type\" : \"text\",\n               \"label\" : \"Article\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : true,\n               \"required\" : false,\n               \"active\" : false,\n               \"order\" : 2 \n             },               \n             {\n               \"name\" : \"text\",\n               \"type\" : \"text\",\n               \"label\" : \"Text\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n                \"show\" : false,\n               \"required\" : true,\n               \"active\" : true,\n               \"listeIdTypeContenuWebForParent\":[],\n              \"listeIdTypeContenuWeb\" : [2,4,5,6,7,10,11,12]\n              },\n              {\n               \"name\" : \"categorie.name\",\n               \"type\" : \"text\",\n               \"label\" : \"Catégorie\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"show\" : true,\n               \"required\" : false,\n               \"active\" : false,\n               \"order\" : 2 \n             },\n             {\n               \"name\" : \"image\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n               \"listeIdTypeContenuWebForParent\":[],\n              \"listeIdTypeContenuWeb\" : [1,2,4,5,6,7,10,11,12]               \n             }, \n              {\n               \"name\" : \"choix_selection\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,                        \n               \"order\" : 3,\n               \"listeIdTypeContenuWebForParent\":[6],\n              \"listeIdTypeContenuWeb\" : [1,2,4,6]\n             },\n             {\n               \"name\" : \"type_content\",\n               \"show\" : false,\n               \"active\" : false,\n               \"required\" : true,                        \n               \"order\" : 3\n             },\n             {\n               \"name\" : \"ordre\",\n               \"type\" : \"text\",\n               \"label\" : \"Ordre\",\n               \"show\" : true,\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 0,\n               \"listeIdTypeContenuWebForParent\":[6],\n              \"listeIdTypeContenuWeb\" : [1,2,3,4,5,6,7,8,10,11,12]\n             },\n             {\n                 \"name\" : \"is_deleted\",\n                 \"type\" :  \"icon\",\n                 \"label\" : \"Supprimer\",\n                 \"filter\" : \n                         {\n                           \"show\" : true,\n                           \"type\" : \"checkbox\",\n                           \"value\" :\"\",\n                           \"operator\" : \"=\"\n                         },\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"show\" : true,\n                 \"active\" : true,\n                 \"required\" : true,\n                 \"order\" : 6\n               },\n             {\n               \"name\" : \"id_ContenuWeb\",\n               \"show\" : false,\n               \"active\" : false,\n                \"type\" : \"text\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"label\" : \"Type ContenuWeb\",\n               \"required\" : true,\n               \"order\" : 3\n             },\n             {\n               \"name\" : \"id_article\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n               \"listeIdTypeContenuWebForParent\":[6],\n              \"listeIdTypeContenuWeb\" : [1,2,3,4,6,8]\n             },\n             {\n               \"name\" : \"id_categorie\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n               \"listeIdTypeContenuWebForParent\":[6],\n              \"listeIdTypeContenuWeb\" : [1,2,3,4,6]\n             },\n             {\n               \"name\" :\"action\",\n               \"type\" : \"action\",\n               \"label\" : \"Action\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"buttons\" :  \n               [\n                 {\"name\" :\"delete\",\"icon\" :\"delete\", \"label\" : \"Supprimer\",\"color\" :\"#f44336\"},\n                 {\"name\" :\"edit\",\"icon\" :\"edit\",\"label\" : \"Editer\",\"color\" :\"#3f51b5\"},\n                 {\"name\" :\"add\",\"icon\" :\"add\",\"label\" : \"Ajouter\",\"color\" :\"#9002fb\"}\n               ],\n            \"active\" : true,\n             \"show\" : true,\n             \"required\" : true,\n             \"order\" : 8\n             }\n           ],\n   \"showFilter\" : true,\n   \"breakpoint\" : 830\n }',NULL,NULL,NULL,NULL,0),(5,'Catégorie colomne ','{\n     \"fields\" : \n             [\n               {\n                 \"name\" : \"name\",\n                 \"type\" : \"text\",\n                 \"label\" : \"Nom\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",                \n                 \"show\" : true,\n                 \"required\" : true,\n                 \"active\" : true,\n                 \"order\" : 1  \n               },  \n               {\n                 \"name\" : \"description\",\n                 \"type\" : \"text\",\n                 \"label\" : \"Description\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"show\" : false,\n                 \"required\" : false,\n                 \"active\" : true,\n                 \"order\" : 2\n                 \n               },   \n               {\n                 \"name\" : \"id_parent\",\n                 \"show\" : false,\n                 \"active\" : false,\n                 \"required\" : false\n               },       \n               {\n                 \"name\" : \"is_deleted\",\n                 \"type\" :  \"icon\",\n                 \"label\" : \"Supprimer\",               \n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"show\" : true,\n                 \"active\" : true,\n                 \"required\" : true,\n                 \"order\" : 2\n               },\n               {\n                 \"name\" : \"ordre\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true\n               },     \n               {\n                 \"name\" : \"title_seo\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true\n               },\n               {\n                 \"name\" : \"description_seo\",\n                 \"show\" : false,\n                 \"active\" : true,\n                 \"required\" : true\n               },\n               {\n                 \"name\" :\"action\",\n                 \"type\" : \"action\",\n                 \"label\" : \"Action\",\n                 \"minWidth\" : \"100px\",\n                 \"width\" : \"30%\",\n                 \"buttons\" :  \n                 [\n                   {\"name\" :\"delete\",\"icon\" :\"delete\",\"label\" : \"Supprimer\",\"color\" :\"#f44336\"}                   \n                 ],\n                  \"active\" : true, \n                  \"show\" : true,\n                 \"required\" : true,\n                 \"order\" : 3\n               }\n             ],\n     \"showFilter\" : true,\n     \"breakpoint\" : 830\n   }',NULL,NULL,NULL,NULL,0),(6,'Nom société','HorizonTopo','Société',NULL,NULL,NULL,1),(7,'Titre page acceuil','Horizon Topo ','SEO',NULL,NULL,NULL,1),(8,'Déscription page ContenuWeb',NULL,'SEO',NULL,NULL,NULL,1),(9,'Titre page qui sommes nous',NULL,'SEO',NULL,NULL,NULL,1),(10,'Déscription page qui sommes nous',NULL,'SEO',NULL,NULL,NULL,1),(11,'Titre page contact',NULL,'SEO',NULL,NULL,NULL,1),(12,'Déscription page contact',NULL,'SEO',NULL,NULL,NULL,1),(13,'ContenuWeb categorie colomne','{\n   \"fields\" : \n           [\n             {\n               \"name\" : \"name\",\n               \"type\" : \"text\",\n               \"label\" : \"Nom\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"text\",\n                 \"value\" : \"\",\n                 \"operator\" : \"\"\n               },\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWeb\" : [1,2,3,4,6,7,8]\n             },\n               {\n               \"name\" : \"choix_selection\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,                        \n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : [4]\n             },\n             {\n               \"name\" : \"text\",\n               \"type\" : \"text\",\n               \"label\" : \"Text\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"text\",\n                 \"value\" : \"\",\n                 \"operator\" : \"\"\n               },\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 2,\n               \"listeIdTypeContenuWeb\" : [1,2,3,4,6,7,8]               \n             },   \n             {\n               \"name\" : \"image\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n               \"listeIdTypeContenuWeb\" : [4]               \n             }, \n             {\n               \"name\" : \"type_content\",\n               \"show\" : false,\n               \"active\" : false,\n               \"required\" : true,                        \n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : []     \n             },\n            {\n               \"name\" : \"ordre\",\n               \"type\" : \"text\",\n               \"label\" : \"Ordre\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"text\",\n                 \"value\" : \"\",\n                 \"operator\" : \"\"\n               },\n               \"show\" : true,\n               \"required\" : true,\n               \"active\" : true,\n               \"order\" : 1,\n               \"listeIdTypeContenuWeb\" : [1,2,3,4,5,6,7,8]\n             },\n             {\n               \"name\" : \"ContenuWebType.type\",\n               \"show\" : true,\n               \"active\" : false,\n                \"type\" : \"text\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"label\" : \"Type ContenuWeb\",\n               \"required\" : true,\n               \"filter\" : \n               {\n                 \"show\" : true,\n                 \"type\" : \"select\",\n                 \"showEmptyValue\" : true,\n                 \"returnProperty\" : \"id_ContenuWeb_type\",\n                 \"data\" : [],\n                 \"value\" : \"\",\n                 \"operator\" : \"\"\n               },\n               \"order\" : 3\n             },\n             {\n               \"name\" : \"id_article\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" :[4]\n             },\n             {\n               \"name\" : \"id_ContenuWeb_type\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : [1,2,3,4,5,6,7,8]\n             },\n             {\n               \"name\" : \"id_categorie\",\n               \"show\" : false,\n               \"active\" : true,\n               \"required\" : true,\n               \"order\" : 3,\n              \"listeIdTypeContenuWeb\" : [4]\n             },\n             {\n               \"name\" :\"action\",\n               \"type\" : \"action\",\n               \"label\" : \"Action\",\n               \"minWidth\" : \"100px\",\n               \"width\" : \"30%\",\n               \"buttons\" :  \n               [\n                 {\"name\" :\"delete\",\"icon\" :\"delete\", \"label\" : \"Supprimer\",\"color\" :\"#f44336\"}\n                \n               ],\n            \"active\" : true,\n             \"show\" : true,\n             \"required\" : true,\n             \"order\" : 8\n             }\n           ],\n   \"showFilter\" : false,\n   \"breakpoint\" : 830\n }',NULL,NULL,NULL,NULL,0),(14,'Adresse ','Zahra rue des fleurs 5865, Tunis ',NULL,NULL,NULL,NULL,0),(15,'Téléphone ','+216 99 999 999',NULL,NULL,NULL,NULL,0),(16,'Mail ','horizontopo@mail.com',NULL,NULL,NULL,NULL,0),(17,'Instagrame ','https://www.instagrame.com',NULL,NULL,NULL,NULL,0),(18,'Facebook ','https://www.facebook.com',NULL,NULL,NULL,NULL,0),(19,'Linkedin','https://www.linkedin.com',NULL,NULL,NULL,NULL,0),(20,'Google maps longitude et latitude','34.777741316325496, 10.744860612509036','Société',NULL,NULL,NULL,0);
